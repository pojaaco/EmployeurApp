...
@Component(id = SearchCallBack.ID,
        name = SearchCallBack.ID,
        resourceBundleLocation = ObservableResourceFactory.RESOURCE_BUNDLE_NAME)
public class SearchCallBack implements CallbackComponent {
    public static final String ID = "SearchCallBack";
